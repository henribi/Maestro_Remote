...
'''
_MQTT_ip='xxx.xxx.xxx.xxx'			#Adresse IP du broker mqtt
...
_MCZip='xxx.xxx.xxx.xxx'			#Adresse IP du poêle
_MCZport='81'						#Port du serveur embarqué du poele
_MCZ_device_serial = ""             # Numero de série du poêle
_MCZ_device_MAC = ""                # Adresse MAC du poêle
_MCZ_App_URL = "http://app.mcz.it:9000"
